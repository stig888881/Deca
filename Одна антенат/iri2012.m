...
%   [20] V. Truhl?k, D. Bilitza, and L. T??skov?, "A new global empirical
...
%   [24] L. T??skov?, V. Truhl?k, J. ?milauer, "An empirical model of
...
data = sscanf(result(newlines(249)+1 : newlines(249 + sweeplen)-1), '%f');